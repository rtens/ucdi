...
class ListGoalsSpec {
    ...
    function multipleBricks() {
        ...
        $this->driver->givenTheGoal('Foo');
        $this->driver->givenTheTask_Of('My Task', 'Goal-1');
        $this->driver->givenTheBrick_For_Scheduled('My Brick', 'Task-2', '2011-12-17 12:00');
        $this->driver->givenTheBrick_For_Scheduled('My Brick', 'Task-2', '2011-12-15 12:00');
        $this->driver->givenTheBrick_For_Scheduled('My Brick', 'Task-2', '2011-12-16 12:00');

        $this->driver->whenIListAllGoals();
        $this->driver->thenThereShouldBe_Goals(1);
        $this->driver->thenGoal_ShouldHaveTheNextBrick(1, 'My Brick @2011-12-15 12:00');
    }
}
